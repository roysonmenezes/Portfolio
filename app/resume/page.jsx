...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Royson Kenute Menezes",
    },
    {
      fieldName: "Phone",
      fieldValue: " (+91) 9035090864",
    },
    {
    ...
    {
      fieldName: "email",
      fieldValue: "royson32004@gmail.com",
    },
    {
          ...
          <div className="min-h-[70vh] w-full">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            {/* dot */}
                            <span className="w-[6px] rounded-full bg-accent">
                              {" "}
                              {item.company}
                            </span>
                            {/* this is gpt */}
                            {/* <span className="w-[6px] h-[6px] inline-block rounded-full bg-accent">{item.company}</span>  */}
                          </div>
                        </li>
                      );
                    })}
            ...
            >
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[1300px] mx-auto xl:mx-0">
